...
public class CircularCounter extends View {
	...
	private Boolean mOneStart = false;

	private Boolean mTwoStart;

	private Boolean mThreeStart;
	...
	private void setupPaints() {
		...
		mMetricPaint.setColor(mTextColor2);
	...
	private void init(TypedArray a) {
		...
		mTextColor2 = a.getColor(R.styleable.CircularMeter_textColor,
				mTextColor2);
	...
	protected void onDraw(Canvas canvas) {
		...
		if (mOneStart) {
			canvas.drawArc(mOneBounds, START_DEGREES, mOneDegrees, false,
					mOnePaint);
		}
		if (mTwoStart) {
			canvas.drawArc(mTwoBounds, START_DEGREES, mTwoDegrees, false,
					mTwoPaint);
		}
		if (mThreeStart) {
		...
		canvas.drawText(mOneValue, mOneBounds.centerX(), mTextPosY, mTextPaint);
	...
	public CircularCounter setFirst(Boolean b) {
		mOneStart = b;
		return this;
	}

	public CircularCounter setSecond(Boolean b) {
		mTwoStart = b;
		return this;
	}

	public CircularCounter setThird(Boolean b) {
		mThreeStart = b;
		return this;
	}
	...
	public CircularCounter setmText(String text) {
		mOneValue = text;
		return this;
	}
